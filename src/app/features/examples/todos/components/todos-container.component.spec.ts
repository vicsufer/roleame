...
describe('TodosComponent', () => {
  ...
  const getTodoInput = () =>
    fixture.debugElement.query(By.css('roleame-webapp-big-input input'));
  ...
  const getAddTodoButton = () =>
    fixture.debugElement
      .queryAll(By.css('roleame-webapp-big-input-action'))[0]
      .query(By.css('button'));

  const getRemoveDoneTodosButton = () =>
    fixture.debugElement
      .queryAll(By.css('roleame-webapp-big-input-action'))[1]
      .query(By.css('button'));
