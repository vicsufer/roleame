...
describe('BigInputActionComponent', () => {
  ...
  it('should be created', () => {
    const template = '<roleame-webapp-big-input-action></roleame-webapp-big-input-action>';
  ...
  it('should disable button if disabled property is set', () => {
    const template =
      '<roleame-webapp-big-input-action [disabled]="true"></roleame-webapp-big-input-action>';
    fixture = createHostComponent(template);
    expect(getButton().nativeElement.disabled).toBeTruthy();
  });

  it('should display icon if fontSet and fontIcon properties are set', () => {
    const template = `<roleame-webapp-big-input-action fontSet="fas" fontIcon="fa-trash"></roleame-webapp-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should display label with provided text when label property is set', () => {
    const template = `<roleame-webapp-big-input-action label="delete"></roleame-webapp-big-input-action>`;
    fixture = createHostComponent(template);
  ...
  it('should emit action event on button click', () => {
    const template = `<roleame-webapp-big-input-action (action)="actionHandler()"></roleame-webapp-big-input-action>`;
    fixture = createHostComponent(template);
